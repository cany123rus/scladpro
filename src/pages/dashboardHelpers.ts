...
export const ASSEMBLY_BUTTONS = [
  ...
  { id: 'cw_tab_boxes', label: 'Сборка: вкладка Коробки' },
  ...
  { id: 'cw_boxes_purchase_add', label: 'Сборка: Коробки - Добавить закупку' },
  { id: 'cw_boxes_fbs_add', label: 'Сборка: Коробки - Добавить ФБС' },
  { id: 'cw_boxes_edit', label: 'Сборка: Коробки - Редактировать запись' },
  { id: 'cw_boxes_delete', label: 'Сборка: Коробки - Удалить запись' },
