...
/**
 * Готовый PNG стикера для вставки в чужой документ.
 *
 * Нужен там, где стикеры идут вперемешку с другими страницами — например,
 * этикетка ЧЗ сразу за своим заданием. Собирать ради этого второй PDF и
 * склеивать его было бы дороже, чем отдать картинку.
 */
export async function renderStickerImage(
  ...
  return render(sticker, width, height, 'PNG', 1);
}
